            ...
            {JourneyPoint.map((value, index) => {
              return (
                ...
                >
                  <>
                    <div
                      className="w-16 h-16 bg-gradient-to-r from-[#126F77] to-[#EB6319] rounded-full
                flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform z-10"
                    >
                      <span className="text-white font-bold">{value.year}</span>
                    </div>
                    <div
                      className="text-card-foreground flex flex-col gap-6 rounded-xl border border-gray-200 flex-1 p-6 bg-white 
                            hover:shadow-xl transition-shadow group-hover:-translate-y-1"
                    >
                      <h3 className="text-xl font-bold text-start text-[#1A1A1A] mb-2 group-hover:text-[#126F77] transition-colors">
                        {value.Head}
                      </h3>
