...
export default function ScheduleDemo() {
  ...
  return (
    <section className="">
      <div className="py-10 sm:py-16 md:py-18 lg:py-20 xl:py-20 2xl:py-20  bg-gradient-to-br from-[#126F77] via-[#0F5A61] to-[#126F77] relative overflow-hidden rounded-4xl">
        {/* Floating shapes */}
        ...
        <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row justify-center  items-center md:items-start gap-4 sm:gap-6 md:gap-8 lg:gap-8 xl:gap-8 2xl:gap-8">
          ...
          <div>
            <div className="flex flex-col gap-3 sm:gap-3.5 md:gap-4 lg:gap-4 xl:gap-4 2xl:gap-4 text-white bg-white/10 items-center p-6 sm:p-8 md:p-10 lg:p-12 xl:p-12 2xl:p-12 rounded-2xl border border-white/20">
              ...
              <p className="text-sm sm:text-sm md:text-base lg:text-base xl:text-base 2xl:text-base text-white/80">
                Choose your preferred time, and <br /> our team will connect
                with you shortly.
              </p>
              <button
                onClick={() => navigate("/contact")}
                className="group inline-flex items-center justify-center gap-1.5 sm:gap-2 md:gap-2 lg:gap-2 xl:gap-2 2xl:gap-2 
                font-medium p-1.5 sm:p-2 md:p-2 lg:p-2 xl:p-2 2xl:p-2 w-full rounded-md bg-secondary hover:bg-[#d4540e] cursor-pointer"
              >
                Book Demo Now
              ...
              <div className="border-t border-white/20 pt-2 sm:pt-3 md:pt-4 lg:pt-4 xl:pt-4 2xl:pt-4">
                <p className="text-white/60 text-xs sm:text-xs md:text-sm lg:text-sm xl:text-sm 2xl:text-sm text-center">
                  ✓ No commitment required • ✓ Free consultation • ✓<br />{" "}
                  Instant setup
                </p>
              </div>
            </div>
