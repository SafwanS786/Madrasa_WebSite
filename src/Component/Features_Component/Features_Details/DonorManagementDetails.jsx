...
import donorImg from "../../../assets/img/Donor.webp"; // UPDATE: Add your image
import { useNavigate } from "react-router-dom";
export default function DonorManagementDetails() {
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 py-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 leading-tight mb-6 text-start">
                <span className="inline">Donor </span>
              ...
              <p className="text-base sm:text-lg text-[#6B6B6B] leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8 text-start">
                Track donations, manage donor relationships, generate receipts,
                and ensure transparency in every contribution with a
                Shariah-compliant system.
              </p>
            ...
            <div className="flex-1">
              <h2 className="text-2xl md:text-3xl font-bold text-[#1A1A1A] mb-6 leading-tight">
                <span className="bg-gradient-to-r from-[#126F77] to-[#EB6319] bg-clip-text text-transparent">
                  Complete Donor Management Solution
                </span>
              </h2>

              <p className="text-base md:text-xl text-[#6B6B6B] mb-6 leading-relaxed">
                DeenNest helps Islamic institutions manage donors, track
                contributions, issue Zakat/Sadaqah receipts, and build lasting
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5 md:gap-6 md:mb-8">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[#6B6B6B] text-sm md:text-base lg:text-lg">
                    Donor Profiles & History
                  </span>
                </div>
                <div className="flex items-center gap-3">
                  <Heart className="w-4 h-4 md:w-6 md:h-6 text-[#126F77]" />
                  <span className="text-[#6B6B6B] text-sm md:text-base lg:text-lg">
                    Donation Tracking
                  </span>
                </div>
              ...
              <ul className="grid grid-cols-1 gap-4 list-disc list-inside">
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Complete donor database with contact and giving history
                </li>
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Track Zakat, Sadaqah, and project-specific donations
                </li>
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Instant digital receipt issuance with tax compliance
                </li>
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Automated thank-you messages and updates
                </li>
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Campaign performance and fundraising reports
                </li>
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  100% Shariah-compliant and interest-free
                </li>
              </ul>
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-[#126F77]/10 to-[#EB6319]/10 rounded-2xl">
                ...
                <p className="text-[#6B6B6B] text-sm">
                  Whether collecting Zakat, building a mosque, or funding
                  education, our donor system ensures full transparency,
                  accountability, and alignment with Islamic principles.
                </p>
              </div>
            </div>
          </div>
