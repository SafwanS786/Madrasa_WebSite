...
import divisionImg from "../../../assets/img/Division.jpg"; // UPDATE: Add your image
import { useNavigate } from "react-router-dom";
export default function DivisionClassManagementDetails() {
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 py-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-[#6B6B6B] leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8 text-start">
                Organize students into divisions, classes, and sections. Assign
                teachers, manage timetables, and track class-wise performance
                with ease.
              </p>

              {/* UPDATE: Same CTA buttons */}
            ...
            <div className="flex-1">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-[#1A1A1A] mb-6 leading-tight">
                <span className="bg-gradient-to-r from-[#126F77] to-[#EB6319] bg-clip-text text-transparent">
                  Complete Division & Class Management
                </span>
              </h2>
              {/* END UPDATE */}

              <p className="text-base md:text-xl text-[#6B6B6B] mb-6 leading-relaxed">
                DeenNest simplifies organizing students into divisions, classes,
                and sections. Assign teachers, create timetables, and monitor
                class performance in real time.
              </p>

              {/* UPDATE: Icon grid – same sizes */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5 md:gap-6 md:mb-8">
                <div className="flex items-center gap-3">
                  <LayoutDashboard className="w-4 h-4 md:w-5 md:h-5 text-[#126F77]" />
                  <span className="text-[#6B6B6B] text-sm md:text-base lg:text-lg">
                    Division & Section Setup
                  </span>
                </div>
                <div className="flex items-center gap-3">
              ...
              {/* UPDATE: Dot bullets – same as StudentDetails */}
              <ul className="grid grid-cols-1 gap-4 list-disc list-inside">
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Create and manage divisions, classes, and sections
                </li>
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Bulk student allocation to classes
                </li>
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                ...
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Class-wise attendance and performance reports
                </li>
                <li className="text-sm md:text-base lg:text-lg text-[#6B6B6B]">
                  Easy promotion and graduation handling
                </li>
              </ul>
              {/* END UPDATE */}
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-[#126F77]/10 to-[#EB6319]/10 rounded-2xl">
                ...
                <p className="text-[#6B6B6B] text-sm">
                  Whether you run a Madrasa with Hifz, Nazra, or Aalim courses,
                  our system adapts to your unique class structures while
                  maintaining Islamic educational standards.
                </p>
              </div>
            </div>
          </div>

          {/* UPDATE: Back button – exact same */}
