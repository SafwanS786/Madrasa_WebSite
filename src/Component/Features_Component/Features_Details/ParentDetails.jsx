...
import parentImg from "../../../assets/img/Parent.jpg";
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12 py-8">
            <div className="flex-1 text-center lg:text-left">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 leading-tight mb-6 text-start">
                <span className="block">Parent & Guardian</span>
              ...
              <p className="text-base sm:text-lg text-[#6B6B6B] leading-relaxed max-w-2xl mx-auto lg:mx-0 mb-8 text-start">
                Empower parents with real-time access to their child’s academic
                progress, attendance, reports, and direct communication with
                teachers — all in one secure, easy-to-use platform.
              </p>
            ...
            <div className="flex-1">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#1A1A1A] mb-6 leading-tight">
                <span className="bg-gradient-to-r from-[#126F77] to-[#EB6319] bg-clip-text text-transparent">
                  Complete Parent Engagement System
                </span>
              </h2>

              <p className="text-base md:text-lg lg:text-xl text-[#6B6B6B] mb-6 leading-relaxed">
                DeenNest provides parents with a dedicated portal to stay
                connected with their child’s education. From daily attendance to
                performance reviews, everything is just a click away.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
                <div className="flex items-center gap-3">
                  <Users className="w-5 h-5 sm:w-6 sm:h-6 text-[#126F77]" />
                ...
                <div className="flex items-center gap-3">
                  <MessageCircle className="w-5 h-5 sm:w-6 sm:h-6 text-[#126F77]" />
                  <span className="text-sm sm:text-base text-[#6B6B6B]">
              ...
              <ul className="space-y-3 md:space-y-4 text-sm md:text-base text-[#6B6B6B] list-disc list-inside">
                {[
                  ...
                  "Track homework, exams, and results",
                  "Receive school announcements and events",
                ].map((item, idx) => (
                  <li key={idx} className="pl-1">
                    <span className=" w-6 h-px bg-[#126F77] mt-2 mr-3 flex-shrink-0"></span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
              ...
              <div className="mt-8 p-5 md:p-6 bg-gradient-to-r from-[#126F77]/10 to-[#EB6319]/10 rounded-2xl">
                ...
                <p className="text-sm md:text-base text-[#6B6B6B]">
                  Our parent portal respects Islamic family values, ensures
                  privacy, and promotes positive engagement between home and
                  madrasa.
                </p>
              </div>
            </div>
