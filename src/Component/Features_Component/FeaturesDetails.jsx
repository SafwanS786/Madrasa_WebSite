...
//           <div className="text-center mb-12 sm:mb-16 md:mb-18 lg:mb-20 xl:mb-20 2xl:mb-20 flex flex-col items-center gap-12">
//             <div>
...
//             </div>
//             <div>
//               <h1 className="text-3xl mx-auto font-bold font-sen text-[#1A1A1A] mb-4 sm:mb-5 md:mb-6 lg:mb-6 xl:mb-6 2xl:mb-6 leading-tight">
...
//                 universities, and training institutes. This cloud-based ERP
//                 software enables institutions to effectively manage admission
//                 forms, collect documents, and shortlist candidates in a secure
//                 online environment.
//               </div>
//             </div>
//           </div>
...
//           <div
//             className="absolute bottom-10 right-10 w-64 sm:w-80 md:w-96 lg:w-[28rem] h-64 sm:h-80 md:h-96 lg:h-[28rem] bg-[#EB6319]/5 rounded-full blur-3xl animate-pulse"
//             style={{ animationDelay: "1s" }}
//           ></div>
//         </div>

//         {/* 🧭 Content Section */}
//         <div className="relative z-10 mx-auto px-4 sm:px-6 md:px-10 text-center">
//           {/* 🏷️ Title */}
//           <h1 className="text-2xl sm:text-3xl md:text-4xl xl:text-5xl font-bold font-sen text-[#1A1A1A] mb-6 leading-tight">
//             Dive Deeper into Our
//             <br />
//             <span className="block bg-gradient-to-r from-[#126F77] to-[#EB6319] bg-clip-text text-transparent">
//               Powerful Features
...
//           {/* 📝 Description */}
//           <p className="text-sm sm:text-base md:text-lg text-[#6B6B6B] max-w-3xl mx-auto leading-relaxed">
...
//           {/* 💡 Subheading */}
//           <h2 className="text-xl sm:text-2xl md:text-3xl xl:text-4xl font-bold font-sen mt-10 mb-4 text-[#1A1A1A] leading-tight">
//             <span className="bg-gradient-to-r from-[#126F77] to-[#EB6319] bg-clip-text text-transparent">
//               Streamline Your Admission Process With Digital Excellence
//             </span>
//           </h2>
...
//           {/* 🧾 Paragraph */}
//           <p className="text-sm sm:text-base md:text-lg text-[#333] max-w-4xl mx-auto leading-relaxed">
//             CAMPUSDEAN’s online student admission management system is a
//             powerful and user-friendly solution for automating and simplifying
//             the student admission process in schools, colleges, universities,
//             and training institutes. This cloud-based ERP software enables
//             institutions to effectively manage admission forms, collect
//             documents, and shortlist candidates in a secure online environment.
//           </p>
//         </div>
//       </div>

//       {/* ✅ Features List Section */}
//       <div className="mt-12 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-32 text-[#1A1A1A] space-y-4">
//         {/* ✳️ Added: Main content for mobile also */}
//         <p>
//           The system centralizes every step of the student enrollment process,
//           reducing paperwork, errors, and improving data accuracy. Admissions
//           teams can manage applications from any location using mobile and web
//           access. This student admission system ensures a smooth, transparent,
//           and streamlined experience for both administrators and applicants,
//           whether it is document verification, eligibility checks, or the
//           generation of admission reports.
//         </p>

//         <p>
//           Upgrade your institute’s admissions process with CAMPUSDEAN for
//           faster, smarter, and safer student admissions.
//         </p>

//         <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mt-6 text-[#126F77]">
//           Features of CAMPUSDEAN Online Student Admission System:
//         </h3>

//         <ul className="list-disc list-inside space-y-2 text-sm sm:text-base">
//           <li>Online submission of application forms</li>
//           <li>No need to wait in long lines.</li>
//           <li>Reduces the need for additional staff.</li>
//           <li>Reduces paperwork through digital processing.</li>
//           <li>Easy to follow up on student inquiries.</li>
//           <li>Students can be easily transferred to school records.</li>
//           <li>User-friendly interface for both staff and students.</li>
//           <li>Admission fees are securely collected online.</li>
//           <li>Fast handling of new student inquiries.</li>
//           <li>Automatically create student merit lists.</li>
//           <li>Instantly generate and send admission letters.</li>
//         </ul>

//         <h3 className="text-lg sm:text-xl md:text-2xl font-semibold mt-6 text-[#EB6319]">
//           Online Student Admission System
//         </h3>

//         <p>
//           CAMPUSDEAN has developed a robust and future-ready Online Student
//           Admission System that simplifies and automates the entire admission
//           process for educational institutions. From inquiry to enrollment, the
//           software offers a seamless digital experience for students and school
//           administrators alike.
//         </p>

//         <p>
//           Students can fill out admission forms online, upload required
//           documents, and securely pay application fees using various payment
//           methods such as credit/debit cards, net banking, or digital wallets.
//         </p>

//         <p>
//           The system also supports manual data entry by schools for walk-in
//           inquiries, making it flexible for both online and offline admission
//           processes. Entrance exams and results can be managed within the
//           platform, and merit lists are auto-generated based on predefined
//           criteria, saving valuable administrative time.
//         </p>

//         <p>
//           Once a student is selected, the software helps generate admission or
//           offer letters, track follow-ups, manage special notes or
//           recommendations, and even integrate with the school’s Student
//           Information System (SIS) for smooth data transfer. With a strong focus
//           on data security and compliance, CAMPUSDEAN ensures that all applicant
